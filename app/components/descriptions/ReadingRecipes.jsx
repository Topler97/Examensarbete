...
//     const [recipes, setRecipes] = useState(); // Initiera state

//     // Fetchar ut både nyheter och recept
//     useEffect(() => {
//   const fetchRecipes = async () => {
//     try {
//       const res = await fetch('/api/recipes'); // Hämta recept från API
//       const recipesData = await res.json(); // Omvandla svaret till JSON
//       setRecipes(recipesData); // Sätt recepten i state
//     } catch (error) {
//       console.error("Fel vid hämtning av recept:", error);
//     }
//   };

//   fetchRecipes(); // Anropa funktionen vid render
