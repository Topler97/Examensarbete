...
const categories = [
  ...
  { name: 'Drinkar', image: '/supply/drinkar.png', link: '/products/Drink' },
  ...
  {
    name: 'Alkoholfritt',
    image: '/supply/soda.png',
    link: '/products/Alkoholfritt',
  },
];
...
export default function OurAssortment() {
  return (
    <div className="lg:mx-15 lg:pb-12">
      <h2 className="lg:text-[26px] text-[20px] font-bold mb-6 ml-5">
